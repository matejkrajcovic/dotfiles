...
vicious.register(wifiwidget, vicious.widgets.wifi, "WIFI: ${ssid}", 10, "wlp7s0")

-- Create a battery widget
batwidget = wibox.widget.textbox()
vicious.register(batwidget, vicious.widgets.bat, "BAT: $2%", 10, "BAT1")
